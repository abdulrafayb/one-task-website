...
export const LogoTicker = () => {
  return (
    <div className="relative bg-black text-white py-[72px] lg:pt-0 lg:pb-24 lg:-mt-20 z-10">
      <div className="container">
        <h2 className="text-xl text-white/70 text-center">
          Trusted by the world&apos;s most innovative teams
        </h2>
        <div className='relative overflow-hidden before:content-[""] before:absolute before:w-5 before:h-full before:top-0 before:left-0 before:bg-[linear-gradient(to_right,#000000,rgb(0,0,0,0))] after:content-[""] after:absolute after:w-5 after:h-full after:top-0 after:right-0 after:bg-[linear-gradient(to_left,#000000,rgb(0,0,0,0))] mt-9'>
