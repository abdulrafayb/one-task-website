...
export const Hero = () => {
  return (
    <div className="relative bg-black text-white bg-[linear-gradient(to_bottom,#000000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 lg:pb-96 overflow-clip">
      <div className="absolute bg-black w-[750px] sm:w-[1536px] lg:w-[2400px] h-[375px] sm:h-[768px] lg:h-[1200px] top-[calc(100%-96px)] sm:top-[calc(100%-120px)] lg:top-[calc(100%-408px)] left-1/2 -translate-x-1/2 border border-[#B48CDE] bg-[radial-gradient(closest-side,#000000_82%,#9560EB)] rounded-[100%]"></div>
        ...
        <div className="flex justify-center mt-8">
          <div className="relative inline-flex">
            ...
            <Image
              ...
              width={200}
              alt=""
              className="absolute top-[56] left-[498px] hidden sm:inline"
            />
